...
if __name__ == "__main__":
    options = Options(
        file="media\AAAAA.mp4",  # アップロードする動画ファイルのパス
        title="Test Title",  # 動画のタイトル
        description="Test Description",  # 動画の説明
        category="22",  # 動画のカテゴリID
        keywords="test, upload",  # 動画のキーワード（カンマ区切り）
        privacyStatus="private",  # 動画の公開設定（"public", "private", "unlisted"のいずれか）
    )
